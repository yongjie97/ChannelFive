            ...
            <div class="row g-0">
              <div class="col-md-6 col-lg-5 d-flex align-items-center bg-custom">
                <div class="text-white py-4 p-md-5 mx-md-4 mx-4">
                  ...
                  <p class="small mb-0">You will be able to partake in discussions and post reviews for university
                    courses!</p>
                </div>
              </div>
                ...
                <div class="card-body p-4 p-lg-5 text-black">
                  ...
                  <form id="registerForm" @submit.prevent="submit">
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="email" id="email" v-model="email" name="email" class="form-control form-control-lg"
                    ...
                    <div class="form-outline mb-4">
                      ...
                      <input type="password" id="password" v-model="password" name="password"
                        class="form-control form-control-lg" :class="{ 'border-danger': v$.password.$error }" />
                      <div class="form-label text-danger" v-if="v$.password.$error">Password must be minimum 8 in
                        length, contains an uppercase, lowercase, number and special character</div>
                    </div>

                    <div class="form-outline mb-4">
                      <label class="form-label" for="displayName">Display Name*</label>
                      <input type="text" id="displayName" v-model="displayName" name="displayName"
                        class="form-control form-control-lg" :class="{ 'border-danger': v$.displayName.$error }" />
                    ...
                    <p class="mb-5 pb-lg-2 text-muted">Already have an account? <router-link class="text-muted"
