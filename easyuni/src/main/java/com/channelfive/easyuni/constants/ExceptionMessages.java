...
public class ExceptionMessages {
    ...
    public static final String ACC_NF_MSG = "Account does not exist";
    public static final String INVALID_VC_MSG = "Invalid verification code.";
    public static final String INVALID_PVC_MSG = "Invalid password reset code.";
    public static final String OLD_PW_NM_MSG = "Old password is incorrect.";
